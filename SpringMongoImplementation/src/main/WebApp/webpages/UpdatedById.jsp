...
<body>
	...
	<form class = "box" method = "post" action = "detailsUpdateById" onsubmit = "return fvalidator()">
		<h1>Update By Id</h1><br>
		<input type = "text" id = "fid" 	name = "cid" placeholder = "Id">
		<input type = "text" id = "fname"	name = "cname" placeholder = "Name">
		<input type = "text" id = "femail"	name = "cemail" placeholder = "E-mail">
		<input type = "text" id = "fphone"	name = "cphone" placeholder = "Phone">
